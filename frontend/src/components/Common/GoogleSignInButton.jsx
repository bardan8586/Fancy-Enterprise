...
const GoogleSignInButton = ({ onSuccess }) => {
  ...
  useEffect(() => {
    ...
    function initializeGoogleSignIn() {
      if (window.google && import.meta.env.VITE_GOOGLE_CLIENT_ID && buttonRef.current) {
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        `}
      >
        {/* Custom overlay with enhanced text */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10 px-4">
          <div className="flex items-center gap-3">
            ...
            {/* Enhanced text with colored "Continue with" */}
            <span className={`
        ...
        {/* Google's actual button (transparent but functional) */}
        <div 
          ref={buttonRef} 
